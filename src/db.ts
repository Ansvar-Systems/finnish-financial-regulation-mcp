/**
 * SQLite database access layer for the Finanssivalvonta MCP server.
 *
 * Schema mirrors the FIN-FSA regulatory document structure:
 *   - sourcebooks        — top-level document categories (FINFSA_Maaraykset, FINFSA_Ohjeet, FINFSA_Kannanotot)
 *   - provisions         — individual regulations, guidelines, and statements
 *   - enforcement_actions — FIN-FSA supervisory decisions and administrative sanctions
 *
