...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across Finanssivalvonta (FIN-FSA) regulatory provisions. Returns matching regulations, guidelines, and statements.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query in Finnish or English" },
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., FINFSA_Maaraykset). Optional." },
        status: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., FINFSA_Maaraykset)" },
  ...
  },
  {
    ...
    description: "List all Finanssivalvonta sourcebook categories.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "fi_fin_search_enforcement",
    description:
      "Search Finanssivalvonta enforcement actions — administrative fines, bans, and public warnings.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Report data freshness: latest provision effective date, latest enforcement action date, and row counts for both tables.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
];
      ...
      switch (name) {
        ...
        case "fi_fin_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "Finanssivalvonta (FIN-FSA) MCP server. Provides access to Finnish financial supervision regulations, guidelines, statements, and enforcement actions.",
