# Finnish Financial Regulation MCP

**Finnish financial regulation data for AI compliance tools.**
...
**Endpoint:** `https://mcp.ansvar.eu/finnish-financial-regulation/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add finnish-financial-regulation-mcp --transport http https://mcp.ansvar.eu/finnish-financial-regulation/mcp` |
...
```json
{
  "mcpServers": {
    "finnish-financial-regulation-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/finnish-financial-regulation/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/finnish-financial-regulation-mcp
```
...
```json
{
  "mcpServers": {
    "finnish-financial-regulation-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/finnish-financial-regulation-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `fi_fin_search_regulations` | Full-text search across Finanssivalvonta (FIN-FSA) regulatory provisions. Returns matching regulations (maaraykset), ... |
| `fi_fin_get_regulation` | Get a specific Finanssivalvonta provision by sourcebook and reference. |
| `fi_fin_list_sourcebooks` | List all Finanssivalvonta sourcebook categories with their names and descriptions. |
...
- **Finanssivalvonta (Finnish Financial Supervisory Authority)** -- Official regulatory authority
...
>
> Regulatory data is sourced from official publications by Finanssivalvonta (Finnish Financial Supervisory Authority). However:
...
```bash
git clone https://github.com/Ansvar-Systems/finnish-financial-regulation-mcp
cd finnish-financial-regulation-mcp
npm install
npm run build
npm test
```
